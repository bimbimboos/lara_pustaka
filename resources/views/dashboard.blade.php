...
<div class="content-wrapper">
    <div class="container">
        ...
        <div class="menu-grid">
            ...
            <a href="{{ route('kategori.index') }}" class="menu-card green fade-in-up delay-2">
                <div class="menu-icon">
            ...
            <a href="{{ route('subkategori.index') }}" class="menu-card orange fade-in-up delay-2">
                <div class="menu-icon">
            ...
            <a href="{{ route('penerbit.index') }}" class="menu-card purple fade-in-up delay-3">
                <div class="menu-icon">
